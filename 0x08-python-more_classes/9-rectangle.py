...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """compares rectangles by area, returns the one which is bigger, or
        if they're equal returns rect_1.
        Return (Rectangle):
            a rectangle object.
        """
    ...
    def square(cls, size=0):
        """conveniently returns a square variant of Rectangle.
        an alternative to inheritance, perhaps?
        check the size.
        Return (Rectangle):
            an instance of a rectangle with width == height
        """
